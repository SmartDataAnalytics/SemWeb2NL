...
import org.aksw.avatar.util.BlackList;
...
public class DBpediaPropertyBlackList implements BlackList {
	...
	private static final String FILE_NAME = "dbpedia/property_blacklist_dbpedia.txt";

	private final Set<String> blacklist;
	
	public static boolean onlyOntologyNamespace = true;

	public DBpediaPropertyBlackList() {
		try {
			...
			throw new RuntimeException("Could not load DBpedia property blacklist from " + FILE_NAME, e);
		}
	}
